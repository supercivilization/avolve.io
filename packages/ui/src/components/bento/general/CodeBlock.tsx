...
// NOTE: This component is currently stubbed out due to build issues
// with refractor package exports in Next.js 16 Beta with both Turbopack and Webpack.
// If you need syntax highlighting, consider using a different library or
// wait for Next.js 16 stable release.
//
// Original implementation used refractor for syntax highlighting
// but import('refractor/lang/tsx') fails in both build systems.
