...
export const metadata: Metadata = {
  ...
  description: "Complete social media system: algorithm changes, authenticity-first content, short-form video dominance, micro-influencer strategies, AI-enhanced workflows. Production-tested with Next.js 16 + React 19.2. Updated November 2025.",
  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <time className="text-sm text-muted-foreground" dateTime="2025-11-25">Last updated: November 25, 2025</time>
