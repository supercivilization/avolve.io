          ...
          <section id="overview" className="mb-12 border border-border/50 bg-gradient-to-b from-background to-muted/20 shadow-sm p-6 rounded-lg">
            ...
            <div className="mt-4 bg-muted/30 p-4 rounded border-l-2 border-border/30">
              ...
              <ul className="space-y-1 text-sm">
                <li>→ <a href="https://ui.shadcn.com" className="text-primary hover:underline">ui.shadcn.com</a> - Official documentation</li>
                <li>→ <a href="https://github.com/shadcn-ui/ui" className="text-primary hover:underline">GitHub Repository</a> - Source code and issues</li>
                <li>→ <a href="https://ui.shadcn.com/docs/cli" className="text-primary hover:underline">CLI Documentation</a> - Installation and usage</li>
              </ul>
            </div>
          </section>
          ...
          <section id="why-matters" className="mb-12 border-t pt-8">
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-border/30 pl-4">
                <h3 className="text-xl font-bold mb-3 text-foreground">Copy-Paste Philosophy: Code Ownership Without Vendor Lock-In</h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-muted p-4 rounded-lg">
                    <h4 className="font-bold text-foreground mb-2">❌ Traditional Component Libraries</h4>
...
// Can't customize without "eject"`}</pre>
                  ...
                  <div className="bg-muted/30 p-4 rounded-lg">
                    <h4 className="font-bold text-foreground mb-2">✅ shadcn/ui Approach</h4>
...
// Modify source directly, no eject needed`}</pre>
              ...
              <div className="border-l-2 border-border/30 pl-4">
                <h3 className="text-xl font-bold mb-3 text-foreground">Radix UI Foundation: Production-Grade Accessibility</h3>
                <p className="text-foreground mb-3">
...
/>`}</pre>
          ...
          <section id="decisions" className="mb-12 border-t pt-8 bg-muted p-6 rounded-lg">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold mb-3 text-foreground">✅ Choose shadcn/ui When:</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-foreground">
                  <li>• <Link href="/software/react" className="text-primary hover:underline">React 19</Link> - UI library foundation</li>
                  <li>• <Link href="/software/tailwind" className="text-primary hover:underline">Tailwind CSS v4</Link> - Styling system</li>
                  <li>• Radix UI - Accessible primitives</li>
                  <li>• <Link href="/software/typescript" className="text-primary hover:underline">TypeScript 5.9</Link> - Type safety</li>
                </ul>
              </div>
              <div>
