      ...
      <main className="page-container">
        ...
        <article>
                ...
                <tbody className="divide-y divide-border/40">
                  <tr className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3">
                      <a href="#runbook-database-slow" className="text-stone-700 dark:text-stone-300 hover:text-stone-800 dark:hover:text-stone-200 hover:underline text-sm">Full Runbook →</a>
                    </td>
                  </tr>
                  <tr className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3">
                      <a href="#common-issues" className="text-stone-700 dark:text-stone-300 hover:text-stone-800 dark:hover:text-stone-200 hover:underline text-sm">Quick Fix →</a>
                    </td>
                  </tr>
                  <tr className="hover:bg-muted/20">
          ...
          <section id="ai-tools-quick-ref" className="mb-12 border border-border/50 rounded-lg overflow-hidden shadow-sm">
            ...
            <div className="bg-muted/10 px-6 py-3 border-t border-border/40">
              <p className="text-sm text-muted-foreground">
                <strong>Full comparison below</strong> • Features, use cases, selection guide • <a href="#ai-coding" className="text-stone-700 dark:text-stone-300 hover:text-stone-800 dark:hover:text-stone-200 hover:underline">View Details →</a>
              </p>
            </div>
          </section>
...
- Confirm slow query count dropped`}
          ...
          <section id="ai-coding" className="section-spacing border-t pt-8">
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-stone-600/40 pl-4">
            ...
            <div className="bg-stone-100 border-l-2 border-stone-600/40 p-4 mt-8">
